...
function ContactSection() {
    return (
        <div className='flex justify-center items-center mt-14 md:mt-24 mx-5'>
            <div
                className='grid grid-cols-2 gap-4 md:gap-10 md:grid-cols-2 md:w-11/12 lg:w-9/12 xl:w-8/12'
                id='contact'
            >
                ...
                <div className='col-span-2 md:col-span-1 py-4 md:py-10 flex flex-col justify-center'>
                    <div className='text-gray-blue-700 text-2xl md:text-3xl font-bold mb-4'>
                        Lets get in touch.
                    </div>
                    <div className='text-xl'>
                        Thank you for taking a look at my portfolio. I am always
                        open to new opportunities and would love to hear from
                        you. Feel free to reach out to me at any time and I will
                        get back to you as soon as possible.
                    </div>
                    <div className='w-fit mt-8'>
                        <BorderBtn
                            link='mailto:jakemoore271@outlook.com'
                            text='Send Email'
                        />
                    </div>
                </div>
